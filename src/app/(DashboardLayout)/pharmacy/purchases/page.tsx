...
export default function PharmacyPurchasesPage() {
  ...
  <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
    <div>
      <h1 className="text-3xl font-bold text-(--color-text)">Purchases</h1>
      <p className="text-(--color-text-muted)">
        Record supplier purchases and keep received stock aligned with inventory.
      </p>
    </div>
    <Button asChild>
  ...
  <div className="grid gap-4 md:grid-cols-3">
    <Card className="rounded-lg bg-(--color-surface) border-(--color-border) text-(--color-text)">
      <CardHeader>
        <CardTitle className="flex items-center gap-2 text-sm text-(--color-text)">
          <ShoppingCart className="size-4 text-(--color-primary)" />
          Total Purchases
        </CardTitle>
      </CardHeader>
    ...
    <Card className="rounded-lg bg-(--color-surface) border-(--color-border) text-(--color-text)">
      <CardHeader>
        <CardTitle className="text-sm text-(--color-text)">Visible Total</CardTitle>
      </CardHeader>
      <CardContent className="text-2xl font-bold text-(--color-text)">
      ...
      <Table>
        <TableHeader>
          <TableRow className="border-(--color-border)">
            ...
            <TableHead className="text-(--color-text-muted)">Supplier</TableHead>
            ...
            <TableHead className="text-(--color-text-muted)">Due</TableHead>
              ...
              <TableRow key={purchase.id} className="border-(--color-border)">
                ...
                <TableCell>
                  <div className="flex flex-wrap gap-1">
                    <Badge variant={purchaseVariant(purchase.purchaseStatus)}>
